...
#init button
button1_pin = DigitalInOut(board.USER_SW) # defaults to input
...
async def monitor_buttons(button1):
    global ledcolor, inBlinkeyMode, inMenu, enableRandomBeep, enableSirenMode,pixel
